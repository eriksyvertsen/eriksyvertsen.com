...
date: "2024-04-18"
description: "The KYC system is broken — redundant, expensive, and surprisingly bad at stopping fraud. Blockchain-based identity passports are the fix."
readTime: 7
---

Every time you open a brokerage account, you perform a ritual. You photograph your driver's license. You type your Social Security number into a form. You wait while a compliance team at a financial institution you've never met reviews your documents, cross-references them against databases, and eventually decides you are who you say you are. Then you do it again for the next account. And the next. And when one of those institutions suffers a data breach eighteen months later, your information — the same information you've now handed to a dozen different companies — ends up on a dark web marketplace.

I spent years at AngelList watching this process at scale. We onboarded thousands of investors into venture funds and SPVs, and every single one of them went through KYC. Many of them had been verified by three, four, five other institutions that same year. The redundancy wasn't just annoying — it was a systemic failure masquerading as diligence.
...
That is what blockchain-based identity passports offer. Not cryptocurrency speculation, not decentralized finance ideology. Just a simple, practical application of existing cryptographic tools to a problem that costs hundreds of billions of dollars and protects almost nobody.
...
Here is the part that surprises people: implementing this does not require new legislation. It requires four targeted regulatory adjustments, all of which could be accomplished through FinCEN interpretive guidance.
...
I want to be clear about what I am and am not arguing. I am not making a libertarian case against regulation. Identity verification serves a legitimate purpose, and financial institutions have real obligations to prevent money laundering and terrorist financing. I am arguing that the current implementation of those obligations is so poorly designed that it undermines the goals it was built to serve.
