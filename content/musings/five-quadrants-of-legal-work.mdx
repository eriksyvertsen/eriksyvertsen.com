...
Everyone agrees AI will transform law.
...
Legal services break into four categories: content (what is the law?), advisory (how does it apply to me?), advocacy (deals, disputes, negotiation), process (producing the documents and deliverables). This misses the fifth: insurance (transferring liability to a credentialed third party).
...
Process came next. I watched it happen in real time during a recent acquisition. Lawyers on working calls saying "Harvey's cooking on the draft, should have it in two hours" where eighteen months ago that meant an all-nighter for associates and a redline the next day. The pace changed visibly. It hasn't made legal work cheaper ... yet. I have a theory about why, but I'll save it.
...
At AngelList, we've maintained legal tickets with full reasoning and comments for seven-plus years. We knew context is gold but couldn't harvest it systematically. That record now becomes one of our most valuable assets. Not for what any individual entry contains, but for what the whole reveals about how we think.

## Where This Lands

I don't expect the ratio of in-house to outside counsel to shift as dramatically as headlines suggest. But the reason for that ratio changes completely.
